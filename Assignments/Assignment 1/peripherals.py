...
class Catalogue:
    ...
    def str_preferences(cls, menu):
        """
        Display food likes and dislikes.
        :param menu: Catalogue food likes and dislikes list
        :return: String
        """
        output = ""
        for item in menu:
    ...
    def print_menu(cls, menu):
        """
        Print GameUI menus.
        :param menu: Catalogue game UI dictionaries.
        :return: None
        """
        output = ""
    ...
    def print_food(cls):
        """
        Print food menu for users to interact with.
        :return: None
        """
        output = ""
        count = 1
